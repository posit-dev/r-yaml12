...
- **Authors of the dependency Rust crates**. Copyright holder.  
  See inst/AUTHORS and LICENSE.note for vendored Rust dependency authors
  and licenses.

## Citation

Source:
[`DESCRIPTION`](https://github.com/posit-dev/r-yaml12/blob/v0.1.0/DESCRIPTION)
